{
#1
# More arguments allows for more input into the function.
# This is because there are only two options for "unit", while "tempVector" can have
  # unlimited values filled with decimals.
# Because the conversion will already apply to every value in the vector without 
  #needing a for loop
...
#Questions to Answer
#1. I would say a 7/10, it really made me think, especially since I am coming back 
#to this after a while
#2. Nothing, I believed I figured it out
#3. Cannot think of anything